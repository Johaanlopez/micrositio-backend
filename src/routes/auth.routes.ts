...
// router.post('/verify-email', verifyEmailCode); // Deshabilitado por migración solo 2FA
// router.post('/send-email-code', sendEmailCode); // Deshabilitado por migración solo 2FA
